#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_UNWEIGHTED_LOSS_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_UNWEIGHTED_LOSS_LAYER_HPP_
...
class SigmoidCrossEntropyUnweightedLossLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyUnweightedLossLayer(const LayerParameter& param)
 ...
 protected:
  /// @copydoc SigmoidCrossEntropyUnweightedLossLayer
...
#endif  // CAFFE_SIGMOID_CROSS_ENTROPY_UNWEIGHTED_LOSS_LAYER_HPP_
