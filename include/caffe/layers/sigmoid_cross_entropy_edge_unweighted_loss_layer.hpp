#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_EDGE_LOSS_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_EDGE_LOSS_LAYER_HPP_
...
class SigmoidCrossEntropyEdgeUnweightedLossLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyEdgeUnweightedLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "SigmoidCrossEntropyEdgeLoss"; }
...
#endif  // CAFFE_SIGMOID_CROSS_ENTROPY_EDGE_LOSS_LAYER_HPP_
